...
const menu = [
  ...
  function displayBtnsCategory(menuItems) {
  ...
  function addButtons() {
    ...
    filterBtns.forEach(function (btn) {
        ...
        const category =  e.currentTarget.dataset.id; // Inorder to use dataset we must have data-<any varible name> = '<any thing>' as parameter in html tag
        if(category != 'all') {
